...
class _BeautifulScreenState extends State<BeautifulScreen> {
  ...
  List imagesList;
  String titlecenter = "Loading Beautiful Game Images...";
  bool liked = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Collections : Beautiful Game',
      ...
      if (res.body == "nodata") {
        ...
        setState(() {
          ...
          imagesList.removeWhere(
              (element) => element['imagescollections'] != "Beautiful Game");
        });
      }
    }).catchError((err) {
      print(err);
